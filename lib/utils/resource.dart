...
class SambazaResource with SambazaInjectable {
  ...
  SambazaResource(this.endpointGenerator, [this.path = '']) {
    inject();
  }
  ...
  Future<Map<String, dynamic>> _get(
    ...
    String urlWithParams = SambazaAPIEndpoints.urlWithParams(path, params);
    if ($$<SambazaStorage>().has(urlWithParams)) {
    ...
    $$<SambazaStorage>().cache(urlWithParams, decoded);
    return decoded;
  }
  ...
  Future<Map<String, dynamic>> $get([
    String id = '',
    Map<String, dynamic>? params,
  ]) => _get('$endpoint${(id ?? '').isEmpty ? '' : '$id/'}', params);

  Future<List<Map<String, dynamic>>> $list([
    Map<String, dynamic>? params,
  ]) async {
    Map<String, dynamic> decoded = await _get(endpoint, params);
  ...
  Future<Map<String, dynamic>> $save(
    ...
    String result = await $$<SambazaAPI>().send(
      endpoint,
      body,
      params ?? {}, // <-- Fix: use empty map if params is null
    );
    return Map<String, dynamic>.from(json.decode(result));
  }
