...
class SambazaAirtimeFieldSet extends StatelessWidget {
  ...
  final FormField<String> Function(String) formFieldBuilder;
  ...
  Widget build(BuildContext context) => SambazaFieldRow(
    children: <Widget>[
      SambazaFieldRow.child(field: formFieldBuilder(airtimeFieldName), flex: 5),
      ...
      Expanded(
        child: IconButton(
          icon: Icon(Icons.delete, semanticLabel: 'Remove item'),
